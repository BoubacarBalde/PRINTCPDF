    ...
    <div style="border: 1px solid black; box-shadow:0px 0px 5px black; padding:1%;background-color:rgb(255, 252, 252);">
        <table style=" margin: 0 auto;">
          ...
          <table style="margin:0 auto; border-collapse: collapse; font-size: 13px;text-align:left;">
            ...
            <tbody>
              <tr>
                <td width="4%"  style="padding:12px; border: 1px solid #0c0202">1</td>
              ...
              <tr>
                <td width="4%"  style="padding:12px;border: 1px solid #0c0202">2</td>
                <td width="37%" style="padding:12px;border: 1px solid #0c0202">VB.NET</td>
                <td width="12%" style="padding:12px;border: 1px solid #0c0202; text-align:center">7</td>
                <td width="10%" style="padding:12px;border: 1px solid #0c0202; text-align:center">8</td>
                <td width="8%"  style="padding:12px;border: 1px solid #0c0202; text-align:center">4</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">C</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">1</td>
              </tr>
              <tr>
                <td width="4%"  style="padding:12px;border: 1px solid #0c0202">3</td>
                <td width="37%" style="padding:12px;border: 1px solid #0c0202">PYTHON</td>
                <td width="12%" style="padding:12px;border: 1px solid #0c0202; text-align:center">7</td>
                <td width="10%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="8%"  style="padding:12px;border: 1px solid #0c0202; text-align:center">9</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">A</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">0</td>
              </tr>
              <tr>
                <td width="4%"  style="padding:12px;border: 1px solid #0c0202">4</td>
                <td width="37%" style="padding:12px;border: 1px solid #0c0202">JAVA SE 1</td>
                <td width="12%" style="padding:12px;border: 1px solid #0c0202; text-align:center">5</td>
                <td width="10%" style="padding:12px;border: 1px solid #0c0202; text-align:center">9</td>
                <td width="8%"  style="padding:12px;border: 1px solid #0c0202; text-align:center">7</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">B</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">4</td>
              </tr>
              <tr>
                <td width="4%"  style="padding:12px;border: 1px solid #0c0202">5</td>
                <td width="37%" style="padding:12px;border: 1px solid #0c0202">PHP/MYSQL 1</td>
                <td width="12%" style="padding:12px;border: 1px solid #0c0202; text-align:center">5</td>
                <td width="10%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="8%"  style="padding:12px;border: 1px solid #0c0202; text-align:center">8</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">A</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">4</td>
              </tr>
              <tr>
                <td width="4%"  style="padding:12px;border: 1px solid #0c0202">6</td>
                <td width="37%" style="padding:12px;border: 1px solid #0c0202">DROIT DE L'INFROMATIQUE</td>
                <td width="12%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="10%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="8%"  style="padding:12px;border: 1px solid #0c0202; text-align:center">8.71</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">D</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">1</td>
              </tr>
              <tr>
                <td width="4%"  style="padding:12px;border: 1px solid #0c0202">7</td>
                <td width="37%" style="padding:12px;border: 1px solid #0c0202">JAVA SE 2</td>
                <td width="12%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="10%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="8%"  style="padding:12px;border: 1px solid #0c0202; text-align:center">7</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">B</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">3</td>
              </tr>
              <tr>
                <td width="4%"  style="padding:12px;border: 1px solid #0c0202">8</td>
                <td width="37%" style="padding:12px;border: 1px solid #0c0202">VB.NET 2</td>
                <td width="12%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="10%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="8%"  style="padding:12px;border: 1px solid #0c0202; text-align:center">8</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">A</td>
              ...
              <tr>
                <td width="4%"  style="padding:12px;border: 1px solid #0c0202">9</td>
                <td width="37%" style="padding:12px;border: 1px solid #0c0202">MACHINE LEARNING</td>
                <td width="12%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="10%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="8%"  style="padding:12px;border: 1px solid #0c0202; text-align:center">7.18</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">B</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">3</td>
              </tr>
              <tr>
                <td width="4%"  style="padding:12px;border: 1px solid #0c0202">10</td>
                <td width="37%" style="padding:12px;border: 1px solid #0c0202">WINDEV MOBILE</td>
                <td width="12%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="10%" style="padding:12px;border: 1px solid #0c0202; text-align:center">6</td>
                <td width="8%"  style="padding:12px;border: 1px solid #0c0202; text-align:center">7.79</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">A</td>
                <td width="14%" style="padding:12px;border: 1px solid #0c0202; text-align:center">4</td>
              </tr>
            </tbody>
